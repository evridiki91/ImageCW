...
Parameters:
  selected = number of elements that were detected, (TP+FP)
  relevant = no of elements that should have been correctly detected
  hit = no of elements that have been correctly detected
***********************************************************************/

double f1score(double selected, double relevant, double hit){
  double tp = hit;
  double fp = selected - tp;
  double fn = relevant - tp;
